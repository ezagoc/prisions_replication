...
Figure \ref{fig:capacity_first_stage} reports the first-stage event studies using 300 km, 400 km, and 500 km treatment radii. The estimates show no clear differential trend before treatment and become negative after the opening of a nearby federal facility. The average effect is negative across all three radii: -0.029 for 300 km, -0.092 for 400 km, and -0.115 for 500 km. The 400 km and 500 km estimates are statistically distinguishable from zero, while the 300 km estimate is negative but imprecise. The fact that the stronger first-stage estimates appear at 400 and 500 km is consistent with the institutional setting: federal prisons were intended to reorganize incarceration across broad regional catchment areas rather than only to affect immediately adjacent municipalities. These estimates provide direct evidence that the treatment generated a meaningful capacity shock, which is the institutional channel underlying the judicial results below.
...
I also examine sentencing outcomes by defendant marginal condition, using the same definitions of marginalized and non-marginalized defendants described above. Figure \ref{fig:es_marginalized_sentencing} separates total sentenced, guilty, guilty prison, guilty money, and not-guilty outcomes into panels and overlays marginal-condition and non-marginal-condition defendants. The resulting pattern is mixed: sentencing effects are positive for both groups in several outcomes, and the relative size of the estimates differs across sentencing margins.
