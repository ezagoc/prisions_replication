...
\hline
ATT, with controls & 0.088 & 0.128 & 0.025 & -0.018 & -0.025 & -0.004 & 0.036 & 0.024 & 0.028 & 0.049 & 0.026 \\
...
\item \emph{Notes:} The table reports CSDID average treatment effects with controls. Standard errors clustered by municipality are in brackets. Outcomes are counts by crime category transformed using \(\log(1+y)\).
\end{tablenotes}
\end{threeparttable}
\end{table}
